...
//			}
	...
	function createSchema() {
		...
		dbDelta( createMembers($charset_collate) );
		dbDelta( createUnits($charset_collate) );
		dbDelta( createUnitTypes($charset_collate) );
		dbDelta( createMemberUnits($charset_collate) );
	}
